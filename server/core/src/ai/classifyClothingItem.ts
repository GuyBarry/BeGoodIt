...
const PROMPT = `Analyze this clothing item image and classify it using only the exact values listed below.
...
export async function classifyClothingItem(image: AIImageInput): Promise<ClothingClassification> {
